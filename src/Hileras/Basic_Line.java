...
/**
 *Clase encargada de instanciar hleras de tipo basico
...
public class Basic_Line implements Line
{
    ...
    {
        this.current=Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("Resources/Current Icons/Basic.png"));
    }
