...
/**
 *Clase encargada de instanciar hileras de tipo B
...
public class B_Line implements Line 
{
    ...
    {
        this.current=Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("Resources/Current Icons/ClaseB.png"));
    }
    ...
    /**
     * Metodo que intercambia 2 enemigos dentro de la hilera
     * @param e Objeto Enemy
     * @param e2 Objeto Enemy
     */
    ...
    /**
     * Metodo que elimina toda la hilera.
     */
    public void destroy()
    {
        this.Head=null;
