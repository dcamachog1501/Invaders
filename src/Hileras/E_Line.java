...
/**
 *Clase encargada de instanciar hileras de tipo E
 * @author dcama
 */
public class E_Line implements Line 
{
    ...
    /**
     * Metodo que establece el ultimo enemigo de la hilera. 
     */
    public void setTail()
    {
        this.Tail=null;
    ...
    {
       this.current=Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("Resources/Current Icons/ClaseE.png"));
    }
    ...
    /**
     * Metodo que retorna el objeto Enemy del final de la hilera.
     * @return Enemy Tail
     */
    ...
    /**
     * Metodo encargado de eliminar toda la hilera. 
     */
    public void destroy()
    {
    ...
    /**
     * Metodo que permite hacer rotar la hilera.
     * @param ang angulo de rotacion
     * @param inX x inicial
     * @param indN int indice a mover
     */
