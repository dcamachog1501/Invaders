...
/**
 *Clase encargada de instanciar hileras de tipo D
...
public class D_Line implements Line
{
    ...
    {
        this.current=Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("Resources/Current Icons/ClaseD.png"));
    }
    ...
    public void createLine() 
    {
      ...
      while(len<lenmax)
      {
          if(len==ind)
          {
          Enemy enm=GUI.buildEnemy(fabricab,this.enmx,this.enmy,this.sup,1,this.gestor,this.lvl,3,giveSpeed());
          enm.setPunt();
          ((Boss)enm).giveHealth();
          this.adder(enm);
          enmx-=100;
          ...
          {
          Enemy enm=GUI.buildEnemy(fabrica,this.enmx,this.enmy,this.sup,1,this.gestor,this.lvl,giveHealth(),giveSpeed());
          this.adder(enm);
          enmx-=100;
          }
      }
    ...
    /**
     * Metodo que retorna el ultimo enemigo de la hilera.
     * @return objeto Enemy.
     */
    ...
    /**
     * Metodo que intercambia un enemigo cualquiera por un jefe.
     * @param x posicion del enemigo a cambiar.
     */
    public void chnBoss(int x)
    {
       ...
       while(true)
       {
        if(x==0)
        {
            ...
            {
                Boss b=new Boss();
                b.Init(this.Head.getX(),this.Head.getY(),this.Head.getSup(),this.Head.getDir(),gestor, lvl,3,giveSpeed());
                ((Boss)b).giveHealth();
        ...
        else if(ind+1==x)
        {
            ...
            {
                Boss b=new Boss();
                b.Init(temp.getNext().getX(),temp.getNext().getY(),temp.getNext().getSup(),temp.getNext().getDir(),gestor, lvl,3,giveSpeed());
                ((Boss)b).giveHealth();
    ...
    /**
     * Metodo que ordena la lista por resistencias utilizando el algoritmo de bubblesort. 
     */
    ...
    {
        int speeder= this.speed;
        if((speeder-(5*(this.lvl/3)))<=0)
        {
            return 1;
        }
        else
        return (speeder-(5*(this.lvl/3)));
    }
}
