...
/**
 *Clase encargada de instanciar hileras de tipo A
...
public class A_Line implements Line
{
    ...
    {
        this.current=Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("Resources/Current Icons/ClaseA.png"));
    }
