...
/**
 * Clase encargada de instanciar enemigos de tipo C.
 * @author Daniel Camacho
 */
public class Type_C implements Enemy
{
    private Enemy next;
    private Image face;
    private int enx;
    ...
    public void setFace() 
    {
        this.face=Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("Resources/Enemigos/ClaseC.png"));
    }
