...
/**
 *Clase encargada de instanciar enemigos de tipo E. 
 * @author dcama
 */
public class Type_E implements Enemy
{
    ...
    public void setFace() 
    {
        this.face=Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("Resources/Enemigos/ClaseE.png"));
    }
