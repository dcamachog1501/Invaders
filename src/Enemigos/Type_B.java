...
/**
 *Clase encargada de instanciar enemigos de tipo B.
...
public class Type_B implements Enemy
{
    ...
    public void setFace() 
    {
       this.face=Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("Resources/Enemigos/ClaseB.png"));
    }
    ...
    /**
     * Metodo que establece el enemigo enlazado al puntero prev del enemigo en cuestion. 
    ...
    /**
     * Metodo que retorna el obejto enemigo enlazado al puntero prev.
     * @return Objeto Enemy
     */
