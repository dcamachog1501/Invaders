...
/**
 *Clase encargada de instanciar enemigos de tipo D.
...
public class Type_D implements Enemy
{
    ...
    public void setFace() 
    {
        this.face=Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("Resources/Enemigos/ClaseD.png"));
    }
