...
/**
 *Clase encargada de instanciar enemigos de tipo A
...
public class Type_A implements Enemy
{
   ...
   public void Init(int x, int y,int sup,int dir, Gestor2 gest, int lvl,int h,int s)
   {
    ...
    public void setFace() 
    {
        this.face=Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("Resources/Enemigos/ClaseA.png"));
    }
