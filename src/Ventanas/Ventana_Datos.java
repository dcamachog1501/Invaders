...
/**
 *Clase encargada de generar ventanas de datos.
...
public class Ventana_Datos extends JFrame
{
 //Variables que almacenan los datos del jugador 
  ...
  private final Image Back1=Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("Resources/Backgrounds/Back.png"));
  private final Image Nav1=Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("Resources/Naves/Nave1.png"));
  private final Image Nav2=Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("Resources/Naves/Nave2.png"));
  private final Image Nav3=Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("Resources/Naves/Nave3.png"));
  private final Image Nav4=Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("Resources/Naves/Nave4.png"));
  private final Image Nav1_1=Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("Resources/Naves/Nave1_1.png"));
  private final Image Nav2_1=Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("Resources/Naves/Nave2_1.png"));
  private final Image Nav3_1=Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("Resources/Naves/Nave3_1.png"));
  private final Image Nav4_1=Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("Resources/Naves/Nave4_1.png"));
  private final Image Right=Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("Resources/Iconos/right.png"));
  private final Image Left=Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("Resources/Iconos/left.png"));
  ...
  private Image back2;
  /**
   * Cosntructor de la clase Ventana Datos
   * @param title String titulo
   * @param Fuente Font fuente
   * @param back Image background
   * @param Icono Icon icono
   * @param Btn Color color morado de los botones
   * @param gest Gestor2 gestor de ventanas.
   */
  ...
  /**
   * Metododque detiene la ejecucion del thread principal.
   */
  public void stop()
  {
      Inicio.stop();
  ...
  /**
   * Metodo que retorna la nave de la ventana.
   * @return Nave nave
   */
  public Nave getNave()
  {
  ...
  /**
   * Metodo que retorna el nombre del jugador actual.
  ...
  public void initJuego()
 {
  ...
  /**
   * Metodo que retorna el Setup de la ventana.
   * @return Setup inicio.
   */
  public Setup getSet()
  {
 ...
 */
  ...
  public void Init()
  {
        ...
        JButton Abort= new JButton("MAIN MENU");
        ...
        JButton goback= new JButton("Abort");
